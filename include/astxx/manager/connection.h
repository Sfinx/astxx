   ...
   namespace manager {
      ...
      class connection {
         ...
         public:
            ...
            typedef std::map<std::string, boost::shared_ptr<boost::signals2::signal<void (message::event)> > > event_handlers_t;
            ...
            boost::signals2::connection register_event(const std::string& e, boost::function<void (message::event)> f);
